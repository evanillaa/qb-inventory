    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html('<p><strong>Serialnumber: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Munition: </strong><span>' + itemData.info.ammo + '</span></p><p><strong>Attachments: </strong><span>' + attachmentString + '</span></p>');
            } else{
                $(".item-info-description").html('<p><strong>Serialnumber: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Munition: </strong><span>' + itemData.info.ammo + '</span></p><p>' + itemData.description + '</p>');
            }
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Amount if cash: </strong><span>€' + itemData.info.cash + '</span></p>');
